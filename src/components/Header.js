...
const InnerItem = (props) => {
    return (
        <div className='inner__item'>
            <img src={props.img} alt="image" className='inner__img'/>
            <p className='inner__text'>fdsfsdf</p>
            <button className="inner__btn">
            ...
            <header className="header">
                <div className="header__container _container">
                    <div className="header__logo logo">
                        <svg className='logo__img' width="32" height="33" viewBox="0 0 32 33" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="header__phone">
                        <svg className='phone__img' width="16" height="16" viewBox="0 0 16 16" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="header__basket basket">
                        <button className="basket__button">
                            ...
                            <div className="button__inner">
                                <p className="inner__title">Корзина</p>
                                <p className='inner__count'>Товаров: {props.count}</p>
                                <div className="inner__place">
                                    <InnerItem/>
                                </div>
                                <a href="http://localhost:3000/ordering" className="inner__link gr">Корзина</a>
                            </div>
                        </button>
                    </div>
                </div>
