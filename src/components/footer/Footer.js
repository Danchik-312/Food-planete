    ...
    return (
        <footer className={styles.footer}>
            <div className={classes(styles.footer__container, "_container")}>
                <div className={classes(styles.footer__logo, styles.logo)}>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={classes(styles.footer__menu, styles.menu)}>
                    <ul className={styles.menu__list}>
                        <li className={styles.menu__item}><Link to="/" className={styles.menu__link}>Главная</Link></li>
                        <li className={styles.menu__item}><a href="#" className={styles.menu__link}>Меню</a></li>
                        <li className={styles.menu__item}><a href="#" className={styles.menu__link}>Доставка</a></li>
                        <li className={styles.menu__item}><a href="#" className={styles.menu__link}>Контакты</a></li>
